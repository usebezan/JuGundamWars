...
namespace Ju.GundamWars.BizMaster.SupportBadges.Domain.Model;

public record SupportBadge : BoostBase
{

    public SupportBadge(int Id, byte Rank, BoostStatusType BoostStatus, CalcType Calc, decimal Value, int Order)
        : base(BoostCategoryType.Mobile, BoostStatus, Calc, Value)
    {
        this.Id = Id;
        this.Rank = Rank;
        this.Order = Order;
