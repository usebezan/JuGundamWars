...
public static class GwIcon
{
    ...
    // カスタム（ユニットと重複以外）カテゴリ
    public static readonly string NCuspa = "HammerWrench";
    public static readonly string SCuspa = "HammerWrench";
    public static readonly string Support = "FaceAgent";
    public static readonly string Badge = "AlphaJCircleOutline";
    // カスタム（複合）カテゴリ
