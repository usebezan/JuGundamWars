using Ju.GundamWars.BizMaster.Roles.Domain.Model;
using Ju.GundamWars.Collections;

namespace Ju.GundamWars.BizMaster.Roles.Domain.Inventory;

public class RoleInventory : MasterObservableCollection<Role>
{
