...
namespace Ju.GundamWars.Domain.CoMobiles.Model;

public partial class CoMobileUpgradedCountSubject : GwObservableObject
{
    ...
    public CoMobileUpgradedCountSubject Reset()
    {
        Hp = 0;
        BeamAttack = 0;
        PhysicalAttack = 0;
    ...
    public CoMobileUpgradedCountSubject Set(CoMobileUpgradedCountSubject status)
    {
        Hp = status.Hp;
