...
namespace Ju.GundamWars.Domain.CoMobiles.Service.Mapping;

public class CoMobileSubjectApplier(
    ...
    : IApplier<CoMobile, CoMobileSubject>
{

    public CoMobileSubject Apply(CoMobile entity, CoMobileSubject subject)
    {
        subject.Initialize(() =>
        {
