...
public partial class CoUnitSubject : SubjectBase
{

    public CoUnitSubject()
    {
        BasicStatus = new CoUnitStatusSubject().AddTo(Disposables);
        UpgradedStatus = new CoUnitStatusSubject().AddTo(Disposables);
        UpgradedCount = new CoUnitUpgradedCountSubject().AddTo(Disposables);
        ActualStatus = new CoUnitStatusSubject().AddTo(Disposables);
    ...
    public CoUnitStatusSubject BasicStatus { get; }
    public CoUnitStatusSubject UpgradedStatus { get; }
    public CoUnitUpgradedCountSubject UpgradedCount { get; }
    ...
    public CoUnitStatusSubject ActualStatus { get; }
