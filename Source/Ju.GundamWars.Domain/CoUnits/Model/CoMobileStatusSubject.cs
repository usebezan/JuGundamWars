...
public partial class CoUnitStatusSubject : GwObservableObject
{
    ...
    public CoUnitStatusSubject Reset()
    {
        Hp = 0;
        BeamAttack = 0;
        PhysicalAttack = 0;
    ...
    public CoUnitStatusSubject Set(CoUnitStatusSubject status)
    {
        Hp = status.Hp;
    ...
    public CoUnitStatusSubject Add(CoUnitStatusSubject status)
    {
        Hp += status.Hp;
        BeamAttack += status.BeamAttack;
        PhysicalAttack += status.PhysicalAttack;
    ...
    public CoUnitStatusSubject AddWithBonus(CoUnitStatusSubject status, decimal multiplier)
    {
