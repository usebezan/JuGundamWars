...
public partial class PilotSubject : SubjectBase
{
    ...
    public List<PilotAbility> AbilitiesForMobile => new[] { Ability1, Ability2, Ability3 }.Where(i => i != null && i.BoostTarget == BoostTargetType.Mobile).Select(i => i!).ToList();
    ...
    {
        if (ability != null && ability.BoostTarget == BoostTargetType.Pilot)
        {
