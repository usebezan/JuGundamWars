...
public partial class SCuspaSelectionViewModel : CuspaListViewModelBase
{

    public SCuspaSelectionViewModel(
        SCuspaSelectionController controller,
        ...
        : base(cuspaInventory, tagInventory, cuspaKindInventory)
    {
        ...
        windowStatus.PropertyChanged.Where(n => n == "SlideIndex" && windowStatus.SlideIndexType == SlideIndexType.SCuspaSelection).Subscribe(WhenSlideIndexChanged).AddTo(Disposables);

        IsIdle = true;
    }


    private readonly SCuspaSelectionController controller;
