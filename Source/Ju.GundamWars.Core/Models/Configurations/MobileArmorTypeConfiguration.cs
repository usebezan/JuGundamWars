...
namespace Ju.GundamWars.Models.Configurations
{
    ...
    public class MobileArmorTypeConfiguration : IEntityTypeConfiguration<MobileArmor>
    {

        public void Configure(EntityTypeBuilder<MobileArmor> builder)
        {
            builder.ToTable(nameof(MobileArmor));
            ...
            // one to one, manually left join
            builder.HasOne(e => e.Support1).WithOne().HasForeignKey<MobileArmor>(e => e.Support1Id).IsRequired(false);
            builder.HasOne(e => e.Support2).WithOne().HasForeignKey<MobileArmor>(e => e.Support2Id).IsRequired(false);
            builder.HasOne(e => e.Support3).WithOne().HasForeignKey<MobileArmor>(e => e.Support3Id).IsRequired(false);
            builder.HasOne(e => e.Support4).WithOne().HasForeignKey<MobileArmor>(e => e.Support4Id).IsRequired(false);
        }
