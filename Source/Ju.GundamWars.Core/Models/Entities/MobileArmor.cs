...
namespace Ju.GundamWars.Models.Entities
{
    ...
    public class MobileArmor : BindableBase, IEntity
    {
        ...
        [NotMapped]
        public MobileArmorType1 MobileArmorType1 => Type1.ToMobileArmorType1();

        [NotMapped]
        public MobileArmorType2 MobileArmorType2 => Type2.ToMobileArmorType2();

        [NotMapped]
        public MobileArmorRoleType RoleType => Role.ToMobileArmorRoleType();
